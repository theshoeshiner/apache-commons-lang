...
public class NumberUtils {
     ...
     *
     * @param decimalNumber The decimal number string, with optional exponential suffix
     ...
     * discussed in many texts [1][2].
     * <b>Note:</b> Zero values are an exceptional case that is unfortunately not often discussed or
     * handled. This implementation aims to retain the implied uncertainty and precision in a zero
     * value such that further mathematical operations can continue to report it. The goal of this
     * logic is to allow zero values to be reported with significant figure counts that match
     * measurements in the same dataset. i.e. if the values 2.1 and 0.0 are measured on the same
     * apparatus and reported in the same dataset, we should be able to convey that they both have 2
     ...
     * decimal digit characters, and are never significant. <br><br>
     * [1] <a href=
